...
public class FastJsonUtils {
	...
	private static Logger logger = Logger.getLogger(FastJsonUtils.class);
	...
	public static void main(String[] args) {
		...
		JSONObject json = stringToJsonObject(reamrkString);
	...
	/**
	 * 从指定的List<map>对象中获取要设置的值后组装成返回给前台的JSON对象字符串. 主要用于给前台分页grid组装数据
	 * 
	 * @param list
	 *            list<map>从数据库中查询出来的数据
	 * @param count
	 *            总数
	 * @return
	 */
	...
	/**
	 * 将list<map>转化为jsonarray 此JSONArray的格式将会是这样[{},{}]
	 * 
	 * @param list
	 * @return
	 */
	...
	/**
	 * 从List<Model>转化成jsonArray list中装的对象为具体的po
	 * 
	 * @param list
	 * @return
	 */
	...
	public static Map<String, JSONObject> jsonArrayToMap(JSONArray jsonArray,
			String key) {
