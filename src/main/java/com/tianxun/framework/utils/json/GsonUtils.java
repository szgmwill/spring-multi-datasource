...
public class GsonUtils {
	...
	private static final boolean isSerializeNulls = true;
	
	private static final boolean escapeHtmlChars = false;
	
	private static final String dateFormat = "yyyy-MM-dd HH:mm:ss";
	
	private static final boolean excludesFieldsWithoutExpose = false;
	...
	public static <T> T json2Bean(String jsonStr, Class<T> objClass) {
		return create().fromJson(jsonStr, objClass);
	}
